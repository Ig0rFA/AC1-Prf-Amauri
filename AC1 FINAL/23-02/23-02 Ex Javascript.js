...
class Cachorro extends Animal {
    emitirSom() {
        console.log(`${this.nome} (cachorro) late: Au!`);
    }
}
...
const livros = [
    new Livro("Harru Potter", 250),
    new Livro("A Voltas do que nçao foram", 500),
    new Livro("Dia D", 350),
    new Livro("Quem pense enriquece", 330),
    new Livro("Biblia", 750),
];
...
const produtos = [
    new Produto("Sapato", 450.00),
    new Produto("Shorts", 25000.00),
    new Produto("Bone", 100.00),
];
