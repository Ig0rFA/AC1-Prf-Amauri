...
const texto1 = "Igor Ferreira Arantes";
...
const texto2 = "Consegui um estagio";
...
// Exemplos de uso
const mail1 = "igor@gmail.com";
const mailValidado1 = validarEmailSimples(mail1);
console.log(`O email '${email1}' é válido? ${mailValidado1}`);

const mail2 = "ferreira@gmail.com";
const mailValidado2 = validarEmailSimples(mail2);
console.log(`O email '${mail2}' é válido? ${mailValidado2}`);
